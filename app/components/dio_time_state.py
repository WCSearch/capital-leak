"""
DIO Time-State Breakdown Component

Displays time-state decomposition for DIO diagnostic analysis.
"""

import streamlit as st
import pandas as pd
from typing import Dict, List, Optional
from utils.dio_analysis import format_currency, get_priority_emoji
...
def render_time_state_breakdown(
    ...
    """
    Render DIO time-state breakdown section.
    ...
    st.markdown('<div class="time-state-header">DIO TIME-STATE ANALYSIS</div>', unsafe_allow_html=True)
...
def render_root_cause_heatmap(root_cause_list: List[Dict], on_drill_callback=None) -> None:
    ...
    st.markdown('<div class="heatmap-header">DIO ROOT CAUSE HEATMAP</div>', unsafe_allow_html=True)
